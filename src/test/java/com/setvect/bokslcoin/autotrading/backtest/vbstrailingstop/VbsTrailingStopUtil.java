...
public class VbsTrailingStopUtil {
    public static void makeReport(VbsTrailingStopCondition condition, List<VbsTrailingStopBacktestRow> tradeHistory, TestAnalysis testAnalysis) throws IOException {
        ...
        report.append(String.format("트레일링스탑 진입\t %,.2f%%", condition.getGainStopRate() * 100) + "\n");
        report.append(String.format("트레일링스탑 매도률\t %,.2f%%", condition.getTrailingStopRate() * 100) + "\n");
